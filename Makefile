...
lp25-backup: $(SRC_DIR)/main.c $(BIN_DIR)/files-list.o $(BIN_DIR)/sync.o $(BIN_DIR)/configuration.o $(BIN_DIR)/file-properties.o $(BIN_DIR)/processes.o $(BIN_DIR)/messages.o $(BIN_DIR)/utility.o $(BIN_DIR)/errors.o
