...
#define MSG_TYPE_TO_MAIN_FROM_SOURCE_LISTER 6
#define MSG_TYPE_TO_MAIN_FROM_DESTINATION_LISTER 7
#define MSG_TYPE_TO_LISTER_FROM_SOURCE_ANALYZERS 8
#define MSG_TYPE_TO_LISTER_FROM_DESTINATION_ANALYZERS 9
#define MSG_TYPE_TO_MAIN_FROM_END_SRC_LISTER 10
#define MSG_TYPE_TO_MAIN_FROM_END_DEST_LISTER 10
